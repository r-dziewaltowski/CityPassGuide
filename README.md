...
To update the database use this command from the Web project folder (replace `CityPassGuide` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../CityPassGuide.Infrastructure/CityPassGuide.Infrastructure.csproj -s CityPassGuide.Web.csproj
```
